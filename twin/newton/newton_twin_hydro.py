...
def main():
    ...
    # Thin the ~2cm-thick asset pad to ~0.4cm so it doesn't shrink the gripper opening from
    # 8cm to ~6cm ("something inside the gripper") and choke the release clearance.
